...
(function (root, factory) {
  ...
  // גיאומטריה מקובץ-הטמפלט המקורי (Template32 p perf.pdf · קווי-חיתוך וקטוריים · media=Trim 1000×700):
  //   עמודות [5..245][255..495][505..745][755..995] (מרווח 10 בין עמודות, שוליים 5).
  //   שורות: זוגות ראש-לראש צמודים [15..180][180..345] · מרווח-חיתוך 10 (345..355) · [355..520][520..685]
  //   → שוליים 15 עליון+תחתון. אומת גם מול קווי-החיתוך בפרופר Ozma (23/188/353·363/528/693 ≡ אותה גיאומטריה).
  var LAYOUT_70x100_32P = {
    ...
    rowTopsTrimMm: [15, 180, 355, 520],   // זוגות ראש-לראש צמודים · שוליים 15 · מרווח-מרכזי 10 (מהטמפלט המקורי)
  ...
  // צד-השדרה של תא (סימון: היכן אין גלישה) — בשטח-הגיליון, לפני תיקון-סיבוב.
  //   העמודות יושבות זוגות-כפולה (0-1 · 2-3): השדרה של כל עמוד פונה אל בן-הזוג שלו →
  //   עמודה זוגית שדרה-מימין, אי-זוגית שדרה-משמאל (מתחלף). תוקן 2026-07-25 — הכלל הקודם
  //   (חצי-שמאלי/חצי-ימני) שם את הגלישה בדיוק בצד-השדרה בכל עמודי-88x63 (RTL: אי-זוגי שדרה-ימין).
