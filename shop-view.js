...
(function (root, factory) {
  ...
  /* ⚠️ ניסוח שנקבע (08/08/2026): מקור **וגם** סוג באותה מחרוזת, כדי שהצוות
     ...
     ⚠️ ‏'file' **לא נגע** בכוונה: הוא סוג רביעי אמיתי (קובץ בודד שאינו
     עיתון מלא — ראה uploadKind), ואינו נכלל בשלושת הערכים שנקבעו. קיפולו
     לתוך אחד מהם היה מציג לצוות מקור שאינו נכון. פתוח להחלטה. */
  var KIND_LABELS = { full: 'עיתון מלא מהפורטל', file: 'קובץ חדש', 'parts-add': 'ריצות מהפורטל', stub: 'העלאה שלא הושלמה' };
