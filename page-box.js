/* ═══════════════════ page-box.js — איזו תיבה היא "העמוד" ═══════════════════
   ...
   ⚠️ **ArtBox הוא הקובע.** זו התיבה שמתארת את התוכן שאמור להידפס, וזו זו
   שאפוגי קורא. מי שמודד MediaBox רואה גם את הגלישה ואת סימוני-החיתוך,
   ולכן "מגלה" הפרש של כמה מ"מ שאינו קיים — או מפספס עמוד שבאמת חורג.

   סדר-הנפילה: ‏ArtBox → TrimBox → CropBox → MediaBox. כל שלב הוא התיבה
