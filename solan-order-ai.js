...
(function (root, factory) {
  ...
  var SYS = 'אתה עוזר של בית דפוס בישראל. חלץ את פרטי ההזמנה מהמסמך. החזר אך ורק שורות בפורמט הבא — שדה אחד בכל שורה, בלי טקסט נוסף ובלי הסברים:\n'
    ...
    + 'מספר אתר: <לעידית — מספר האתר/הסניף אם מופיע (למשל "שם האתר: 48" → 48), מספר בלבד; אחרת ריק>\n'
    + 'אסמכתא: <רק אם במסמך מופיע במפורש סוג-אסמכתא — טלפוני / מייל / הזמנה חתומה. אל תמציא ואל תכתוב כאן מקום או שם-אתר; אם אין — ריק>\n'
  ...
  function parseOrderTags(text) {
    var map = { 'לקוח': 'customer', 'תיאור': 'desc', 'כמות': 'qty', 'תאריך': 'date',
                'כתובת': 'address', 'מספר אתר': 'siteNum', 'שם האתר': 'siteNum', 'אזור': 'area', 'הערות': 'notes',
                'אסמכתא': 'reference',
                'מספר הזמנה': 'poNumber', 'הזמנת רכש': 'poNumber', 'מספר הזמנת רכש': 'poNumber' };
    var out = { customer: '', desc: '', qty: '', date: '', address: '', siteNum: '', area: '', notes: '',
                poNumber: '', reference: '', items: [] };
